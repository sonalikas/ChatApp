                ...
                child: Padding(
                  ...
                  child: StreamBuilder(
                    ...
                    builder: (context, AsyncSnapshot<QuerySnapshot> snapshots){
                      List data = snapshots.data!.docs.where((element) => element['email'].toString().contains(search )||element['email'].toString().contains(search)).toList()!;
                      return  ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          return ChatWidgets.card(
                            ...
                            time:
                            //'11:11',
                            DateFormat('EEE hh:mm').format(DateTime.timestamp()),
                             onTap: () {
